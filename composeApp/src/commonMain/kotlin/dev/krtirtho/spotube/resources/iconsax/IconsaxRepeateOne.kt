...
val Iconsax.IconsaxRepeateOne: ImageVector
    get() {
        if (_IconsaxRepeateOne != null) {
            return _IconsaxRepeateOne!!
        }
        _IconsaxRepeateOne = ImageVector.Builder(
            name = "IconsaxRepeateOne",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _IconsaxRepeateOne: ImageVector? = null
